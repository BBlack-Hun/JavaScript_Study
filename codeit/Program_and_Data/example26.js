...
// 코드를 작성해 주세요.
let startPart = lyrics.indexOf('[형돈]');
let part = lyrics.slice(startPart);
let endPart = part.indexOf('[',1);
const startEnd = startPart + endPart;

hyungdon = lyrics.slice(startPart, startEnd);
